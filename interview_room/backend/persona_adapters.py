...
class PersonaOrchestrator:
    ...
    def __init__(self, workspace_root: Path) -> None:
        ...
        self.interviewer_model = os.environ.get("INTERVIEWER_MODEL", self.chat_model)
    ...
    def _load_env(self) -> None:
        env_candidates = [
            ...
            self.workspace_root / "interview_room" / ".env",
    ...
    def ask_interviewer(
        ...
        state: PersonaRuntimeState,
        *,
        top_k: int | None = None,  # kept for call-shape compatibility
    ) -> dict[str, Any]:
        del top_k
        ...
        if not response_text:
            raise RuntimeError("Interviewer model returned no text output.")
